            ...
            <div className="navbar-fixed">
                <nav className="purple darken-4">
                    <div className="nav-wrapper">
                        ...
                        <a href="#home" className="brand-logo s12 "> <img src={img} width="6%" height="6
                        %" alt="logo"></img>    Trade Track</a>
                        <ul className="right hide-on-med-and-down">
                            {currentUser && <div>
                                ...
                                <li>
                                    < Link to='/login' className='waves-effect waves-light purple darken-4 ' onClick={handleLogOut}><i class="material-icons">power_settings_new</i>
                                    </Link></li>
                            </div>
                            }
                            {!currentUser && <div><li>
